...
for bound_type in bounds:
    ...
    for numDemo in numDemos:  
        ...
        for rep in range(num_reps):
            filename = "ProjectionEvalRepeatedDemo_numdemos" +  str(numDemo) + "_alpha" + str(alpha) + "_chain" + str(chain_length) +  "_step" + str(step) + "0000_L1sampleflag" + str(sample_flag) +  "_rolloutLength" + str(rolloutLength) +  "_stochastic" + str(stochastic) + "_rep" + str(rep)+ ".txt"
