...
int main() 
{
    ...
    const unsigned int numDemo = 10;            //number of demos to give
    const unsigned int rolloutLength = 100;          //max length of each demo
    const double alpha = 100; //50                    //confidence param for BIRL
    const unsigned int chain_length = 100;//1000;//5000;        //length of MCMC chain
